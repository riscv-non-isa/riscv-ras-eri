...
[NOTE]
====
It is recommended that if the `status_i` register is written when `v=1`, the
register accept the write only to the `cec` field and preserve the value held
in other fields of the register.
