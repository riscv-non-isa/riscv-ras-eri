...
include::reri_intro.adoc[]
include::reri_registers.adoc[]
include::reri_sw_guidelines.adoc[]
include::reri_hw_guidelines.adoc[]
include::reri_bibliography.adoc[]
