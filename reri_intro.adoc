...
| Data             | A collection of symbols coded in a format that can be input
                     to and processed by a computing system. This includes data
                     in the form of coded instructions to control the operations
...
| Error Reporting  | Error reporting is the process of logging information
                     ...
                     a detected error in an error record and signaling the
                     occurrence of the error to an appropriate RAS handler.
